...
//    }
    ...
    void 이미지_다량_저장() {
        ...
        List<User> users = userService.getAllUserShard();
        ...
        for (Product product : productList) {
            for (User user : users) {
                for (int i = 0; i < 10; i++) {
                    ...
                    productImgService.upsertProductImg(ProductImg.createProductImg(product, productImgType, title, "test", user.getUserId()));
                }
            }
        }
    }
